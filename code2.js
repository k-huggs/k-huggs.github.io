...
gdjs.Start_32ScreenCode.GDEmoteCrossObjects1= [];
gdjs.Start_32ScreenCode.GDEmoteCrossObjects2= [];
gdjs.Start_32ScreenCode.GDEmoteCrossObjects3= [];
...
gdjs.Start_32ScreenCode.GDBlankButtonObjects3= [];
...
gdjs.Start_32ScreenCode.GDtrueObjects1= [];
gdjs.Start_32ScreenCode.GDtrueObjects2= [];
gdjs.Start_32ScreenCode.GDtrueObjects3= [];
...
};gdjs.Start_32ScreenCode.mapOfGDgdjs_46Start_9532ScreenCode_46GDtrueObjects1Objects = Hashtable.newFrom({"true": gdjs.Start_32ScreenCode.GDtrueObjects1});
...
gdjs.Start_32ScreenCode.mapOfGDgdjs_46Start_9532ScreenCode_46GDLeaderboardTxtObjects1Objects = Hashtable.newFrom({"LeaderboardTxt": gdjs.Start_32ScreenCode.GDLeaderboardTxtObjects1});
...
gdjs.copyArray(runtimeScene.getObjects("LeaderboardTxt"), gdjs.Start_32ScreenCode.GDLeaderboardTxtObjects1);

gdjs.Start_32ScreenCode.condition0IsTrue_0.val = false;
gdjs.Start_32ScreenCode.condition1IsTrue_0.val = false;
{
gdjs.Start_32ScreenCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Start_32ScreenCode.mapOfGDgdjs_46Start_9532ScreenCode_46GDLeaderboardTxtObjects1Objects, runtimeScene, true, false);
}if ( gdjs.Start_32ScreenCode.condition0IsTrue_0.val ) {
{
...
gdjs.Start_32ScreenCode.condition0IsTrue_0.val = false;
{
gdjs.Start_32ScreenCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Start_32ScreenCode.mapOfGDgdjs_46Start_9532ScreenCode_46GDSignInTxtObjects1Objects, runtimeScene, true, true);
}if (gdjs.Start_32ScreenCode.condition0IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.Start_32ScreenCode.GDSignInTxtObjects1.length ;i < len;++i) {
    gdjs.Start_32ScreenCode.GDSignInTxtObjects1[i].enableEffect("Hovering", false);
}
}}
...
gdjs.Start_32ScreenCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9403428);
}
}}
if (gdjs.Start_32ScreenCode.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("MusicEmote"), gdjs.Start_32ScreenCode.GDMusicEmoteObjects1);
...
gdjs.copyArray(runtimeScene.getObjects("true"), gdjs.Start_32ScreenCode.GDtrueObjects1);

gdjs.Start_32ScreenCode.condition0IsTrue_0.val = false;
gdjs.Start_32ScreenCode.condition1IsTrue_0.val = false;
{
gdjs.Start_32ScreenCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Start_32ScreenCode.mapOfGDgdjs_46Start_9532ScreenCode_46GDtrueObjects1Objects, runtimeScene, true, false);
}if ( gdjs.Start_32ScreenCode.condition0IsTrue_0.val ) {
{
gdjs.Start_32ScreenCode.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
...
gdjs.Start_32ScreenCode.GDEmoteCrossObjects1.length = 0;
gdjs.Start_32ScreenCode.GDEmoteCrossObjects2.length = 0;
gdjs.Start_32ScreenCode.GDEmoteCrossObjects3.length = 0;
...
gdjs.Start_32ScreenCode.GDBlankButtonObjects3.length = 0;
...
gdjs.Start_32ScreenCode.GDtrueObjects1.length = 0;
gdjs.Start_32ScreenCode.GDtrueObjects2.length = 0;
gdjs.Start_32ScreenCode.GDtrueObjects3.length = 0;
